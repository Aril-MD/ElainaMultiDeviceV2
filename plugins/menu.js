...
const tagnya = await conn.getName(m.sender)
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [            
              {
                "name": "quick_reply",
                "buttonParamsJson": "{\"display_text\":\"Aʟʟ Mᴇɴᴜ\",\"id\":\".allmenu\"}"
              }, 
{
                "name": "quick_reply",
                "buttonParamsJson": "{\"display_text\":\"Sᴄʀɪᴘᴛ\",\"id\":\".sc\"}"
              }, 
              {
                "name": "quick_reply",
                "buttonParamsJson": "{\"display_text\":\"Cʀᴇᴅɪᴛ\",\"id\":\".tqto\"}"
              }, 
{
                "name": "cta_url",
                "buttonParamsJson": "{\"display_text\":\"Cʀᴇᴀᴛᴏʀ\",\"url\":\"https://wa.me/628156808952?text=Halo+Aril+Ganteng\",\"merchant_url\":\"https://chat.whatsapp.com/HoW2ThdVF9k8YWN577S5Js\"}"
