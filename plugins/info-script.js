    ...
    message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          body: proto.Message.InteractiveMessage.Body.create({
            text: "PENCET TOMBOL DI BAWAH INI"
          }),
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [            
                                          {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"SCRIPT\",\"url\":\"https://github.com/Aril-MD/ElainaMultiDeviceV2/\",\"merchant_url\":\"https://chat.whatsapp.com/HoW2ThdVF9k8YWN577S5Js\"}"
              }
           ],
          })
        })
