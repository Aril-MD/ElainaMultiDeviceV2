...
`.trimStart(),
  ...
  footer: '╰─── –',
  after: `ᴇʟᴀɪɴᴀ ᴀɪ ʙʏ ᴀʀɪʟ ᴀʀᴅɪᴀɴsʏᴀʜ ${global.version}`,
}
  try {
    ...
    let bjir = 'https://telegra.ph/file/353f44873bec061cfc032.jpg'
      ...
      video: fs.readFileSync('./menuvid/elaina.mp4'),
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    thumbnailUrl: 'https://telegra.ph/file/353f44873bec061cfc032.jpg',
                    sourceUrl: 'https://s.id/Aril',
                    mediaType: 1,
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴇʟᴀɪɴᴀ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://chat.whatsapp.com/HoW2ThdVF9k8YWN577S5Js', thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
